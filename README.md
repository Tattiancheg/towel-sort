...
```
 [1, 2, 3, 6, 5, 4, 7, 8, 9 ]
```
Ваша задача реализовать так называемый алгоритм «сортировки полотенец».

Функция `полотенцеСорт` должна ожидать [матрица] (https://en.wikipedia.org/wiki/Array_data_structure#Multidimensional_arrays) любой формы, например:
